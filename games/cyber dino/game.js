...
function showDeathScreen(info) {
    ...
    this.add.text(cx, cy - 118, info.emoji + "  THREAT DETECTED: " + info.title, {
        ...
        color: "#ffffff",
        fontStyle: "bold",
        shadow: { offsetX: 0, offsetY: 0, color: "#" + info.color.toString(16).padStart(6, "0"), blur: 12, fill: true }
    }).setOrigin(0.5);
    ...
    this.add.text(cx - 200, cy - 72, "FINAL SCORE", {
        fontFamily: "'Courier New', monospace", fontSize: "11px", color: "#556677", letterSpacing: 3
    });
    ...
    if (isNewBest) {
        this.add.text(cx - 200, cy - 20, "★ NEW BEST!", {
            fontFamily: "'Courier New', monospace", fontSize: "13px", color: "#ffdd00"
        });
    }

    // Explanation
    this.add.text(cx + 40, cy - 72, "THREAT ANALYSIS:", {
        fontFamily: "'Courier New', monospace", fontSize: "10px", color: "#556677", letterSpacing: 2
    });
